...
{
	// Quad tessellation
	initShader(L"tessellation_vs.cso", L"tessellation_hs.cso", L"tessellationDepth_ds.cso", L"tessellationDepth_ps.cso");
}
...
void TessellationDepthShader::initShader(WCHAR * vsFilename, WCHAR * psFilename)
{
...
void TessellationDepthShader::initShader(WCHAR * vsFilename, WCHAR * hsFilename, WCHAR * dsFilename, WCHAR * psFilename)
{
...
void TessellationDepthShader::setShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX &worldMatrix, const XMMATRIX &viewMatrix, const XMMATRIX &projectionMatrix, ID3D11ShaderResourceView* texture, float tessFactor, XMFLOAT4 waveVariables, XMFLOAT3 camPos)
{
	HRESULT result;
